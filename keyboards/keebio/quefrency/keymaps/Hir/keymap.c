...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, MO(_FN1),KC_LGUI, KC_LALT, KC_SPC,           KC_SPC,  XXXXXXX, KC_RALT, MO(_FN1),XXXXXXX, KC_APP,  KC_RCTL
  ),

  [_FN1] = LAYOUT(
    KC_TILD, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  XXXXXX,  KC_DEL, \
