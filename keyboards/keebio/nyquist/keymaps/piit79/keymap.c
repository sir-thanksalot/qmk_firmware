...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT( \
        ...
        CZECH,    KC_LCTL,  KC_LGUI,  KC_LALT,  LOWER,    KC_BSPC,  NAV_SPC,   RAISE,   KC_LEFT,  KC_DOWN,   KC_UP,   KC_RGHT  \
    ),
    [_CZECH] = LAYOUT( \
    ...
    [_LOWER] = LAYOUT( \
        ...
        _______,   KC_F7,    KC_F8,    KC_F9,    KC_F10,  KC_F11,   KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME,  KC_END,   _______, \
         RESET,   _______,  _______,  _______,  _______,  _______,  KC_SPC,   _______,    KC_MPLY,   KC_VOLD,  KC_VOLU,  KC_MNXT  \
    ),
    [_RAISE] = LAYOUT( \
        ...
        _______,  _______,  _______,  _______,  _______,  KC_DEL,   KC_SPC,   _______,  KC_MPLY,  KC_VOLD,  KC_VOLU,  KC_MNXT  \
    ),
    [_NAV] = LAYOUT( \
    ...
    [_ADJ] = LAYOUT( \
        ...
        _______,  RGB_TOG,  RGB_MOD,  RGB_HUD,  RGB_HUI,  _______,  _______,  TERM_ON,  KC_VOLU,  _______,  _______,  KC_DEL,  \
        _______,  RGB_SAD,  RGB_SAI,  RGB_VAD,  RGB_VAI,  _______,  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  _______, \
        _______,  _______,  _______,  _______,  _______,   MI_ON,    MI_OFF,  _______,  KC_VOLD,  _______,  _______,  _______, \
