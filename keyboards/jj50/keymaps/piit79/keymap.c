...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT( \
        ...
        CZECH,    KC_LCTL,  KC_LGUI,  KC_LALT,  LOWER,    NAV_SPC,  KC_NO,    RAISE,    KC_LEFT,  KC_DOWN,   KC_UP,   KC_RGHT  \
    ),
    [_CZECH] = LAYOUT( \
    ...
    [_LOWER] = LAYOUT( \
        ...
        _______,  _______,  _______,  _______,  _______,  KC_SPC,   _______,  _______,    KC_MPLY,   KC_VOLD,  KC_VOLU,  KC_MNXT  \
    ),
    [_RAISE] = LAYOUT( \
    ...
    [_ADJ] = LAYOUT( \
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  VERSION,   RESET   \
    )
};
